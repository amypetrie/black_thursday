...
class SalesAnalystTest < MiniTest::Test
  ...
  def test_find_number_item_objects_per_merchant
    ...
    sales_analyst = sales_engine.analyst
    assert_equal 7, sales_analyst.find_item_object_per_merchant.count
  end
  ...
  def test_find_number_of_items_per_merchant
    ...
    assert_equal expected, sales_analyst.find_number_of_items_per_merchant
  end
  ...
  def test_find_merchants_with_high_item_count
    ...
    assert_equal "", sales_analyst.merchant_and_item_count_hash
