...
class SalesAnalystTest < MiniTest::Test
  ...
  def test_sort_invoice_items_by_revenue
    ...
    assert_instance_of Array, sales_analyst.sort_invoice_items_by_revenue(12334105)
  end
  ...
  def test_paid_invoices_to_invoice_items
    ...
    assert_instance_of Array, sales_analyst.paid_invoices_to_invoice_items(12334105)
  end
end
